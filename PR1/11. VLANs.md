...
| VLAN | Red | Uso |
|------|-----|-----|
| VLAN 10 | 10.1.10.0/24 | DMZ — Firewall |
| VLAN 20 | 10.1.20.0/24 | Servicios — DNS, IDS |
| VLAN 30 | 10.1.30.0/24 | SOC — Grafana, SOAR, SIEM |
| VLAN 40 | 10.1.40.0/24 | Producción — Windows AD |
...
```
vmbr1.10@vmbr1  inet 10.1.10.1/24
vmbr1.20@vmbr1  inet 10.1.20.1/24
vmbr1.30@vmbr1  inet 10.1.30.1/24
vmbr1.40@vmbr1  inet 10.1.40.1/24
```
