...
; VLAN 30 - SOC (10.1.1.64/27) — nuevos
...
dig @10.1.1.34 homepage.soc.local +short
dig @10.1.1.34 vaultwarden.soc.local +short

# Resolución inversa
dig @10.1.1.34 -x 10.1.1.66 +short
dig @10.1.1.34 -x 10.1.1.67 +short
dig @10.1.1.34 -x 10.1.1.68 +short
dig @10.1.1.34 -x 10.1.1.80 +short
...
|----------|-------------|------|--------|
| honeypot | 10.1.1.130 | 50 | VM203 honeypot — pendiente despliegue |
</document_content>
